						...
						if(idsadded == false) {
							...
							if(split.length > 1)
							{
								...
								if(split[1].matches("\\d*"))
								{
									...
									{
										player.sendMessage(ChatColor.RED+"This page does not exist! There " + (maxpage == 1 ? "is" : "are") + " only: "+ChatColor.LIGHT_PURPLE+maxpage+ChatColor.RED+ (maxpage == 1 ? " page!" : " pages!"));
									}
									else
									{
