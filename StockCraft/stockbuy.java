...
public class stockbuy
{
	...
	{
		if(StockCraftProperties.perm == false ||  StockCraftPermissions.getInstance().stockbuy(player))
		{
			String amount = "1";			
					...
					try{
						...
						if(price <= bankmoney.checkmoney(player) || amountof < 0)
						{
							if(amountof < 0){
								...
								player.sendMessage(ChatColor.GREEN+amount+" "+idname+" stocks bought -> "+price);
							}
							else if(amountof > 0){
